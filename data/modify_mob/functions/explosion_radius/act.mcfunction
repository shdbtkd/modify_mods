...
# 확률 계산
scoreboard players operation @s modifyMob = explosionRadius modifyMob
scoreboard players operation @s modifyMob *= @s perResult
scoreboard players operation @s modifyMob /= genericPerMax perResult

# 결과 적용
execute store result entity @s ExplosionRadius byte 1 run scoreboard players get @s modifyMob